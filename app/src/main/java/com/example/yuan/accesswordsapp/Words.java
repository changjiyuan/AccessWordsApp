package com.example.yuan.accesswordsapp;
...
public class Words {
    ...
    public static final String AUTHORITY = "com.example.yuan.mywordbook.cn.edu.bistu.cs.se.words.MyContentProvider";//URI授权者
